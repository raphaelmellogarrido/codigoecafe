...
// Banco clonado do Clube Presença original (renato_de_paula) para o Clube
// Nutri — preencha com as credenciais do banco já clonado.
define('DB_HOST', 'localhost');
define('DB_USER', 'coloque_o_usuario_real_aqui');
define('DB_PASS', 'coloque_a_senha_real_aqui');
define('DB_NAME', 'coloque_o_nome_do_banco_clonado_aqui');
