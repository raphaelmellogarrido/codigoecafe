...
if ($aluno) {
    ...
    $link = 'https://codigoecafe.com/comunidade-nutri/redefinir-senha?token=' . $token;
    $nome = $aluno['nome'] ?: 'Aluno';

    $assunto = 'Redefinir senha — Clube Nutri';
    $corpo = "Olá, $nome!\n\n"
        . "Recebemos um pedido para redefinir sua senha do Clube Nutri.\n\n"
        . "Clique no link abaixo para criar uma nova senha (válido por 1 hora):\n"
        . "$link\n\n"
        . "Se você não pediu isso, pode ignorar este email — sua senha continua a mesma.\n";
    $headers = "From: Clube Nutri <nao-responda@codigoecafe.com>\r\n"
