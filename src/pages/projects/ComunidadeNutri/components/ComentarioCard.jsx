...
function ComentarioCard({
  ...
  async function handleAlterarVisibilidade(novoValor) {
    ...
    try {
      ...
      console.error("[Clube Nutri] falha ao alterar visibilidade:", err);
  ...
  async function handleSalvarEdicao(e) {
    ...
    try {
      ...
      console.error("[Clube Nutri] falha ao editar comentário:", err);
  ...
  async function handleReagir(emoji) {
    ...
    try {
      ...
      console.error("[Clube Nutri] falha ao reagir:", err);
    } finally {
      setReagindo("");
    }
  }
  ...
  async function handleEnviarResposta(e) {
    ...
    try {
      ...
      console.error("[Clube Nutri] falha ao enviar resposta:", err);
