...
function DificuldadeDoDia() {
  ...
  const carregarInicial = useCallback(() => {
    ...
    buscarPrimeiraPagina()
      ...
      .catch((err) => {
        console.error("[Clube Nutri] falha ao carregar 'Sua prática hoje' (após retry):", err);
  ...
  const carregarMais = useCallback(() => {
    ...
    buscarComentarios(`${COMENTARIOS_URL}?aula_id=${AULA_ID}&limit=${TAMANHO_PAGINA}&offset=${offset}${paramEmail(email)}`)
      ...
      .catch((err) => {
        console.error("[Clube Nutri] falha ao carregar mais comentários:", err);
  ...
  async function handleEnviar(e) {
    ...
    try {
      ...
      console.error("[Clube Nutri] falha ao compartilhar:", err);
    } finally {
      setEnviando(false);
    }
  }
  ...
  async function handleExcluir(id) {
    ...
    try {
      ...
      console.error("[Clube Nutri] falha ao excluir comentário:", err);
