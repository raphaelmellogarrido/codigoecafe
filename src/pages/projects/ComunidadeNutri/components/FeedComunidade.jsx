    ...
    fetch(`${POSTS_URL}?page=${paginaAlvo}&per_page=${POR_PAGINA}`, { signal })
      ...
      .catch((err) => {
        if (err.name !== "AbortError") {
          console.error("[Clube Nutri] falha ao carregar feed da comunidade:", err);
          setPosts([]);
          setTotal(0);
        }
      });
...
// Mural da comunidade (Clube Nutri), parte do produto único de
    ...
    return (
      <section className="cm-feed-bloqueado">
        ...
        <div className="cm-feed-overlay-construcao">
          ...
          <p>A Comunidade faz parte do Clube Nutri: curso + comunidade por R$49,90/mês.</p>
