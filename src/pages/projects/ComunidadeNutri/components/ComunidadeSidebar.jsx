...
const NAV_ITEMS = [
  { label: "Início", icon: Home, to: "/comunidade-nutri", end: true },
  { label: "Aulas", icon: Library, to: "/comunidade-nutri/aulas-raiz" },
  // { label: "Meditações da Semana", icon: CalendarDays, to: "/comunidade-nutri/meditacoes-semana" },
  // { label: "Ao Vivo", icon: Video, to: "/comunidade-nutri/ao-vivo", comBolinha: true },
  // { label: "Comunidade", icon: Users, to: "/comunidade-nutri/comunidade" },
  // { label: "Meu Progresso", icon: BarChart3, to: "/comunidade-nutri/progresso" },
  { label: "Configurações", icon: Settings, to: "/comunidade-nutri/configuracoes" },
];
  ...
  return (
    <aside className="cm-sidebar-left">
      ...
      <nav className="cm-sidebar-nav">
        ...
        {admin && (
          <NavLink to="/comunidade-nutri/admin" aria-label="Admin" className={({ isActive }) => `cm-sidebar-nav-item ${isActive ? "is-ativo" : ""}`}>
      ...
      <div className="cm-sidebar-footer">
        <NavLink to="/comunidade-nutri/mensagens" className="cm-ajuda-card cm-mensagens-card">
