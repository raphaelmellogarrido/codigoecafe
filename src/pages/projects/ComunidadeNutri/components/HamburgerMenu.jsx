    ...
    <>
      ...
      <div className={`cm-hamburger-drawer ${open ? "is-open" : ""}`} role="dialog" aria-modal="true" aria-label="Menu">
        ...
        <nav className="cm-hamburger-nav">
          <NavLink to="/comunidade-nutri" end onClick={fechar} className={({ isActive }) => `cm-hamburger-link ${isActive ? "is-ativo" : ""}`}>
            <Home size={18} strokeWidth={1.8} />
            <span>Início</span>
          </NavLink>

          <NavLink to="/comunidade-nutri/aulas-raiz" onClick={fechar} className={({ isActive }) => `cm-hamburger-link ${isActive ? "is-ativo" : ""}`}>
            <Library size={18} strokeWidth={1.8} />
            <span>Aulas</span>
          </NavLink>

          <NavLink to="/comunidade-nutri/mensagens" onClick={fechar} className={({ isActive }) => `cm-hamburger-link ${isActive ? "is-ativo" : ""}`}>
          ...
          <NavLink to="/comunidade-nutri/configuracoes" onClick={fechar} className={({ isActive }) => `cm-hamburger-link ${isActive ? "is-ativo" : ""}`}>
            <Settings size={18} strokeWidth={1.8} />
            <span>Configurações</span>
          </NavLink>

          {admin && (
            <NavLink to="/comunidade-nutri/admin" onClick={fechar} className={({ isActive }) => `cm-hamburger-link ${isActive ? "is-ativo" : ""}`}>
