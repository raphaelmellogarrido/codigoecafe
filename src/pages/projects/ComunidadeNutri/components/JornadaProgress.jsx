 ...
 * em vez do `<Link to="/comunidade-nutri/aulas-raiz">`. Só faz sentido true na
 * própria AulasMeditacaoRaiz.jsx — sem isso o card mostrava "Bora pra
 * aula?" levando pra `/comunidade-nutri/aulas-raiz` mesmo já estando nela.
    ...
    <div className="cm-jornada cm-grid-progresso">
      <div className="cm-jornada-topo">
        ...
        {statusJornada.estado === "bora-aula" && !ocultarLinkBoraAula ? (
          <Link to="/comunidade-nutri/aulas-raiz" className={`cm-jornada-badge cm-jornada-badge--${statusJornada.estado} cursor-pointer hover:opacity-80`}>
